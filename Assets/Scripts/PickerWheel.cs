...
namespace EasyUI.PickerWheelUI {
    ...
    public class PickerWheel : MonoBehaviour {
        ...
        public void Generate () {
            ...
            float pieceWidth = Mathf.Lerp (pieceMinSize.x, pieceMaxSize.x, 1f - Mathf.InverseLerp (piecesMin, piecesMax, wheelObjectCount)) ;
            float pieceHeight = Mathf.Lerp (pieceMinSize.y, pieceMaxSize.y, 1f - Mathf.InverseLerp (piecesMin, piecesMax, wheelObjectCount)) ;
            rt.SetSizeWithCurrentAnchors (RectTransform.Axis.Horizontal, pieceWidth) ;
            rt.SetSizeWithCurrentAnchors (RectTransform.Axis.Vertical, pieceHeight) ;

            for (int i = 0; i < SpinManager.Instance.wheelObjects.Count; i++)
            {
                DrawPiece(i);
            }
        ...
        public void DrawPiece (int index) {
            ...
            pieceTrns.GetChild (2).GetComponent <TextMeshProUGUI> ().text = "x" + piece.Amount.ToString ();
        ...
        public void Spin () {
            ...
            if (piece.Chance == 0 && nonZeroChancesIndices.Count != 0) {
                ...
                piece = SpinManager.Instance.wheelObjects[index];
            }
        ...
        public void OnSpinEnd (UnityAction<WheelObject> action) {
        ...
        private int GetRandomPieceIndex () {
            ...
            if (SpinManager.Instance.wheelObjects[ i ]._weight >= r)
                return i ;
